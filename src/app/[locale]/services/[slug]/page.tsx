...
Dù bạn đang làm việc với keo đơn thành phần, epoxy hai phần, silicone, polyurethane, hay hợp chất đổ khuôn đa thành phần, hệ thống của chúng tôi mang lại độ chính xác và khả năng lặp lại vượt trội. Thiết bị của chúng tôi từ các đơn vị để bàn cho R&D và sản xuất lô nhỏ đến hệ thống inline tự động hoàn toàn cho sản xuất khối lượng lớn.`,
    features: [
      ...
      },
      {
        ...
        descEn: 'Dynamic and static mixing solutions for 2K, 3K, and multi-part formulations.',
        descVi: 'Giải pháp trộn động và tĩnh cho công thức 2K, 3K và nhiều thành phần.',
      },
      {
        icon: Target,
        titleEn: 'Precision Metering',
        titleVi: 'Đo lường Chính xác',
        descEn: 'Volumetric and gravimetric dispensing with ±1% accuracy.',
        descVi: 'Phân phối thể tích và trọng lượng với độ chính xác ±1%.',
      },
      {
        icon: Cpu,
        titleEn: 'Smart Process Control',
        titleVi: 'Điều khiển Quy trình Thông minh',
        descEn: 'Industry 4.0 ready systems with data logging and process monitoring.',
        descVi: 'Hệ thống sẵn sàng Industry 4.0 với ghi dữ liệu và giám sát quy trình.',
      },
    ],
    applications: [
...
Our converting facility processes everything from thin films (25 microns) to thick foam materials (50mm+), including pressure-sensitive adhesives, double-coated tapes, thermal interface materials, EMI shielding materials, and specialty foams.`,
    overviewVi: `Bộ phận Dịch vụ Chuyển đổi của Creative Engineering chuyên biến nguyên liệu keo dán thành các linh kiện kỹ thuật chính xác.
...
Cơ sở chuyển đổi của chúng tôi xử lý mọi thứ từ màng mỏng (25 micron) đến vật liệu xốp dày (50mm+), bao gồm keo nhạy áp, băng phủ đôi, vật liệu giao diện nhiệt, vật liệu che chắn EMI và xốp đặc biệt.`,
  ...
  },
  {
    ...
    overviewEn: `In industrial environments, labels aren't just identifiers—they're critical components of safety and compliance.

We offer comprehensive labeling solutions including UL/CSA recognized materials, chemical-resistant labels, high-temperature labels, and serialized labels with variable data.`,
    overviewVi: `Trong môi trường công nghiệp, nhãn không chỉ là công cụ nhận dạng—chúng là thành phần quan trọng của an toàn và tuân thủ.
...
Chúng tôi cung cấp giải pháp nhãn toàn diện bao gồm vật liệu UL/CSA, nhãn chống hóa chất, nhãn chịu nhiệt cao và nhãn số hóa với dữ liệu biến đổi.`,
  ...
  },
  {
    ...
    overviewEn: `Creative Engineering's Laser & Die Cutting services combine the precision of modern laser technology with the efficiency of traditional die cutting methods.

Our CO2 and fiber laser systems handle intricate patterns in thin films, plastics, textiles, foams, and select metals with micron-level precision.`,
    overviewVi: `Dịch vụ Cắt Laser & Khuôn của Creative Engineering kết hợp độ chính xác của công nghệ laser hiện đại với hiệu quả của phương pháp cắt khuôn truyền thống.
