...
import { User, MapPin, Phone, Mail, Package, Star, Clock, CheckCircle } from 'lucide-react';
...
export default async function DashboardPage() {
  ...
  const loyaltyProgress = loyaltyPoints ? Math.min((loyaltyPoints / 1000) * 100, 100) : 0;
